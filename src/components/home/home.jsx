                    ...
                    <Row>
                        <Col lg={12} md={12} xs={12}>
                            <div className="homeSectionIntro">
                                <p className="homeIntroHead">Revolutionizing video & audio crowdfunding with royalty pool NFTs</p>
                                <p className="homeIntroDesc">Redefining the creator economy with royalty crowdfunding</p>
                            </div>
                        </Col>
                    </Row>
                </Container>
